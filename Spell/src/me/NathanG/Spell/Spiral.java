...
public class Spiral extends SpellMethods{
	...
	public Spiral(Player player, MainSpell main, double damage, Particle particle, int mana, double cooldown, String acts)
	{
		super(player, main, damage, particle, mana, cooldown, acts);
	}
	public void spell()
	{
			//bar.setBarProgress(0.5);
		    new BukkitRunnable() {
