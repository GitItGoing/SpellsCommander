...
public class ParticleBeam extends SpellMethods{
	...
	public ParticleBeam(Player player, MainSpell main, double damage, Particle particle, int mana, double cooldown, String acts)
	{
